"""PlaybookRunScreen -- live ansible-playbook output streamer for the client."""
        ...
        try:
            ...
            async for raw in proc.stdout:
                ...
                if "PLAY RECAP" in line or "ok=" in line:
                    ...
                    log.write(line)
            await proc.wait()
            self._exit_code = proc.returncode or 0
...
def _find_repo_root() -> str:
    ...
    # playbook_screen.py -> screens/ -> xinas_client/ -> client_repo/
