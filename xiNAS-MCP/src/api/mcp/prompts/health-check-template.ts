/**
 * The shipped copy of the xinas_health_check prompt body (S19 spec §5.5, D-03).
 *
 * GENERATED from docs/control-path/s19-mcp-health-prompt-template.md
 * ("## Prompt body" section, trimmed) — the docs file is the source of
 * truth and mcp-prompts.test.ts asserts equality. Edit the docs file, bump
 * HEALTH_PROMPT_VERSION in ./health-check.ts, and regenerate this constant;
 * never edit the text below by hand.
 */

export const HEALTH_PROMPT_TEMPLATE = `You are diagnosing the xiNAS resources explicitly included in this
